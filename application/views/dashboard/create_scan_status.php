		...
		<table class="table" width="100%">
			<tbody>
				<tr class="{cycle values='odd,even'}">
					...
					<td>
						<input type="text" name="scan_name" id="textfield" placeholder="Masukkan Text" class="input-xlarge text_field form-control" value="" style="margin-top: 13px; width: 250px; margin-left: 7px;" max-length="100">
					</td>
				</tr>
				<tr>
					<td></td>
