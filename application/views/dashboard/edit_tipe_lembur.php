        ...
        <table class="table" width="100%">
            <tbody>
                <tr class="{cycle values='odd,even'}">
                    ...
                    <td>
                        <input type="text" name="type_name" id="textfield" placeholder="Masukkan Text" class="input-xlarge text_field form-control" value="<?= isset($index_type_data) ? $index_type_data['type_name'] : ''; ?>" style="margin-top: 13px; width: 250px; margin-left: 7px;" max-length="50" required>
                    </td>
                </tr>
                <tr>
                    <td></td>
