...
<div class="panel panel-orange">
  <div class="panel-heading">
  	<h5><i class="fa fa-table"></i> List Pegawai Belum Punya Jabatan</h5>
  </div>
          ...
          <tbody>
            <?php foreach($data_info as $d) { ?>
              <tr>
                  ...
                  <td><?= $d->eselon; ?></td>
                  <td>
                    <a href="<?= base_url('absensi_2017/show/'.$d->nip_baru); ?>" class="btn btn-sm btn-info" rel="tooltip" title="Lihat">
